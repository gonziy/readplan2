...
namespace DTcms.Web.UI
{
    public partial class BasePage : System.Web.UI.Page
    {
        ...
        protected List<Model.UserReadLog> get_user_read_log_list(string where)
        {
            int count = 0;
            return new BLL.UserReadLog().List(10000,1,where,"category_id asc,article_id asc",out count);
        }

        protected List<Model.UserReadBook> get_user_read_book_list(string where)
        {
            int count = 0;
            return new BLL.UserReadBook().List(where);
        }
        /// <summary>
        /// 获取可合成的列表
        /// </summary>
