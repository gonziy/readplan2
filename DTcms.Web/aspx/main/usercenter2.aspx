...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append(linkurl("usercenter","index2"));
	...
	templateBuilder.Append("\">\r\n            <span class=\"icon icon-left\"></span>\r\n        </a>\r\n        <h1 class=\"title\">邀请好友</h1>\r\n    </header>\r\n    <div class=\"content\" style=\" padding-top:1.5rem; background:#fff;\">\r\n        ");
	if (userModel.is_pay!=null)
	{

	if (userModel.is_pay>1)
	{

	templateBuilder.Append("\r\n            <div id=\"inviter_qrcode\">\r\n                <h2>悦读二维码</h2>\r\n                <p style=\"margin:.2rem 0;\">");
	templateBuilder.Append(Utils.ObjectToStr(userModel.nick_name));
	templateBuilder.Append("的二维码(ID:");
	templateBuilder.Append(Utils.ObjectToStr(userModel.id));
	templateBuilder.Append(")</p>\r\n                <div class=\"note\">\r\n                    <img src=\"");
	templateBuilder.Append(Utils.ObjectToStr(config.webpath));
	templateBuilder.Append("upload/InviterQRCode/");
	templateBuilder.Append(userModel.id.ToString());

	templateBuilder.Append(".png\" alt=\"\" />\r\n                </div>\r\n            </div>\r\n            ");
	}
	else
	{

	templateBuilder.Append("\r\n            <div id=\"no-data\" style=\"text-align:center\"><span>消费后才可拥有自己的二维码</span></div>\r\n            ");
	}	//end for if
