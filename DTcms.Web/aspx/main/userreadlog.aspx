...
override protected void OnInit(EventArgs e)
{
	...
	*/
	...
	templateBuilder.Append("/templates/main");
	templateBuilder.Append("/plugins/layer/layer.js?v=2\"></");
	templateBuilder.Append("script>\r\n</head>\r\n\r\n<body>\r\n\r\n\r\n\r\n    ");
	if (action=="zhengben")
	{

	List<DTcms.Model.UserReadBook> list = get_user_read_book_list("user_id='"+userModel.id +"'");
	...
	templateBuilder.Append(get_category_title(DTcms.Common.TypeConverter.ObjectToInt(book.category_id),"unknow").ToString());

	templateBuilder.Append("》</div>\r\n											<div class=\"item-after\"><span class=\"badge\">");
	templateBuilder.Append(Utils.ObjectToStr(book.count));
	...
	List<DTcms.Model.UserReadLog> list = get_user_read_log_list(" read_type='1' and user_id='"+userModel.id +"' and (read_count-compose_count>'0')");
	...
	List<DTcms.Model.ComposeList> composeList = get_user_compose_list(userModel.id);
	...
	templateBuilder.Append(DTcms.Common.TypeConverter.ObjectToInt(DTcms.Common.TypeConverter.ObjectToInt(log.read_count)-DTcms.Common.TypeConverter.ObjectToInt(log.compose_count)).ToString());
